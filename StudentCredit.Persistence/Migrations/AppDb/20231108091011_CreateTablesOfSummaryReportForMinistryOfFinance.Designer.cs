...
namespace StudentCredit.Persistence.Migrations.AppDb
{
    ...
    [Migration("20231108091011_CreateTablesOfSummaryReportForMinistryOfFinance")]
    partial class CreateTablesOfSummaryReportForMinistryOfFinance
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudentCredit.Data.Applications.ApplicationFour.ApplicationFourHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("applicationfourhistory");
                });
            ...
            modelBuilder.Entity("StudentCredit.Data.Applications.ApplicationOne.ApplicationOneHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("applicationonehistory");
                });
            ...
            modelBuilder.Entity("StudentCredit.Data.Applications.ApplicationFour.ApplicationFourHistory", b =>
                {
                    b.HasOne("StudentCredit.Data.Applications.ApplicationFour.ApplicationFour", null)
                        .WithOne("ApplicationFourHistory")
                        .HasForeignKey("StudentCredit.Data.Applications.ApplicationFour.ApplicationFourHistory", "ApplicationFourId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("StudentCredit.Data.Applications.ApplicationOne.ApplicationOneHistory", b =>
                {
                    b.HasOne("StudentCredit.Data.Applications.ApplicationOne.ApplicationOne", null)
                        .WithOne("ApplicationOneHistory")
                        .HasForeignKey("StudentCredit.Data.Applications.ApplicationOne.ApplicationOneHistory", "ApplicationOneId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("StudentCredit.Data.Applications.ApplicationFour.ApplicationFour", b =>
                {
                    b.Navigation("ApplicationFourHistory");
            ...
            modelBuilder.Entity("StudentCredit.Data.Applications.ApplicationOne.ApplicationOne", b =>
                {
                    b.Navigation("ApplicationOneHistory");
                });
            ...
            modelBuilder.Entity("StudentCredit.Data.SummaryReport.Sheet", b =>
                {
                    b.Navigation("SheetYears");
                });

            modelBuilder.Entity("StudentCredit.Data.SummaryReport.SheetYear", b =>
                {
                    b.Navigation("MonthDatas");
                });
